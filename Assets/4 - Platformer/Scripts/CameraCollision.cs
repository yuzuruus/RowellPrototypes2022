...
// Credit to https://sharpcoderblog.com/blog/third-person-camera-in-unity-3d for script!

/*  How to use
 *      1. Attach to main camera
 *      2. Assign 'CameraParent' to reference transform variable
 *      3. Tweak offsets if needed
 * 
 */
